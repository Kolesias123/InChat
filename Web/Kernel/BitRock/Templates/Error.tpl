			...
			<div class="box">
				<div class="c1">
					...
					<details open>
						...
						<p class="more">
							...
							<b>Versión del Kernel:</b> <?php echo $Info['version.full']; ?>
						</p>
				...
				<div class="c2">
					...
					<section>
						...
						<p>Para más información y reporte de otros problemas por favor envie un correo electrónico a: <a href="mailto:<?php echo $config['errors']['email.to']; ?>"><?php echo $config['errors']['email.to']; ?></a></p>
					</section>
					<?php } ?>
					
					<section>
						<p>Por favor vuelva a la <a onclick="history.back()">página anterior</a> o a la <a href="<?php echo PATH; ?>">página de inicio</a>.</p>
					</section>
				</div>
			</div>
